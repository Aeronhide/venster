...
export const metadata: Metadata = {
  title: "PVC Windows — Profiles, Glass, Hardware & Installation",
  description:
    "PVC windows with VEKA/GEALAN profiles, ROTO hardware and energy-efficient glass. " +
    "5-year warranty, manufacturer prices, free engineer consultation, " +
    "measurement and installation across the Netherlands.",
  alternates: {
    canonical: `${SITE_URL}/en/pvc-ramen`,
    languages: {
      nl: `${SITE_URL}/pvc-ramen`,
      en: `${SITE_URL}/en/pvc-ramen`,
    },
  },
};
...
export default function EnPvcRamenPage() {
  return (
    <>
      <HeroPvcRamen />
      <PvcProfiles />
